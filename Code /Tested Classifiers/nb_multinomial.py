...
with open("../Results/nb_multinomial_results.txt", "w") as text_file:
	...
	for i in range(5):
		...
		# Save model
		pickle.dump(nb, open("../Models/nb_multinomial{}.model".format(i+1), 'wb'))
...
csv_writer(t1, "../Results/nb_Multinomial_valid.csv","wb")
csv_writer(t2, "../Results/nb_Multinomial_train.csv","wb")
csv_writer(t3, "../Results/nb_Multinomial_test.csv","wb")
