...
with open("../Results/ab_results.txt", "w") as text_file:
	for i in range(5):
		...
		# Save model
		pickle.dump(ab, open("../Models/ab{}.model".format(i+1), 'wb'))
		...
		#Train
		y_prediction = ab.predict(train_data)
		...
		y_prediction = ab.predict(test_data)
...
csv_writer(t1, "../Results/ab_valid.csv","wb")
csv_writer(t2, "../Results/ab_train.csv","wb")
csv_writer(t3, "../Results/ab_test.csv","wb")
