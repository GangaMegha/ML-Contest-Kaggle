#RANDOM FOREST : Using Probabilities
...
with open("../Results/rf_prob_results.txt", "w") as text_file:
	...
	for i in range(5):
		...
		# Save model
		pickle.dump(rf, open("../Models/rf_prob{}.model".format(i+1), 'wb'))

		if(i!=0):
			y_prediction_valid = y_prediction_valid + rf.predict_proba(validation_data)
		else:
			y_prediction_valid = rf.predict_proba(validation_data)
		...
		#Train
		if(i!=0):
			y_prediction_train = y_prediction_train + rf.predict_proba(train_data)
		else:
			y_prediction_train = rf.predict_proba(train_data)

		#Test
		print("\n\nRunning test........................")

		if(i!=0):
			y_prediction_test = y_prediction_test + rf.predict_proba(test_data)
		else:
			y_prediction_test = rf.predict_proba(test_data)
...
csv_writer(t1, "../Results/rf_prob_valid.csv","wb")
csv_writer(t2, "../Results/rf_prob_train.csv","wb")
csv_writer(t3, "../Results/rf_prob_test.csv","wb")
