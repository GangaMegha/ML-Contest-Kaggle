...
with open("../Results/rf_results.txt", "w") as text_file:
	for i in range(5):
		...
		# Save model
		pickle.dump(rf, open("../Models/rf{}.model".format(i+1), 'wb'))
...
csv_writer(t1, "../Results/rf_valid.csv","wb")
csv_writer(t2, "../Results/rf_train.csv","wb")
csv_writer(t3, "../Results/rf_test.csv","wb")
